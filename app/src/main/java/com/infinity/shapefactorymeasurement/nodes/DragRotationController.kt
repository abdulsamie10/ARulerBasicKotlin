...
class DragRotationController(
    ...
    override fun onContinueTransformation(gesture: DragGesture) {
        ...
        // Define a scaling factor to reduce the rotation amount
        val rotationScale = 0.1f

        val deltaAngleY = rotationAmountY * rotationScale
        val deltaAngleX = rotationAmountX * rotationScale
